...
public class TestService extends PluginService
{
    ...
    public void onCreate() {
        super.onCreate();
        showToast("Service1 -->创建service");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        showToast("Service1 -->销毁service");
    }

    @Override
    public void onStart(Intent arg0, int arg1) {
        super.onStart(arg0, arg1);
        showToast("Service1 -->service onStart");
    }

    @Override
    public int onStartCommand(Intent arg0, int arg1, int arg2) {
        showToast("Service1 -->service onStartCommand");
        return super.onStartCommand(arg0, arg1, arg2);
    }

    @Override
    public IBinder onBind(Intent intent) {
        showToast("Service1 -->service onBind");
        return super.onBind(intent);
    }

    @Override
    public boolean onUnbind(Intent arg0) {
        showToast("Service1 -->service onUnbind");
